    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Take Book Details</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active">Take Book Details</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Take Books From Students | සිසුන්ගෙන් පොත් භාර ගැනීම.</h3>
...
<script>
    ...
    function load_table(table_data) {
        ...
        table = $("#students_table").DataTable({
            ...
            "ajax": {
                "url": "admin-control/take-books.php",
                "type": "POST",
                "data": table_data,
            },
